...
from src.guidance.HIV_regressor_discrete_CE import HIVRegressorDiscreteCE
...
def main(cfg: DictConfig):
    ...
    assert dataset_config.name == "moses"
    ...
    guidance_model = HIVRegressorDiscreteCE.load_from_checkpoint(os.path.join(cfg.general.trained_regressor_path))
